...
This package provides a collection of functions to display emacs in Bangla.
  ...
  - This  package provides custom functions to display the
    ...
    create custom modeline in Bangla. As a bonus this package takes
    the excellent [[https://github.com/seagle0128/doom-modeline][doom-modeline]] and modifies it to show the modeline
    in Bangla and hence if you already use ~doom-modeline~ package then
    you have to do less to display your modeline in Bangla (see the
    screenshots below).
